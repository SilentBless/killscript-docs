...
`GetTranslation()` только возвращает строку и ничего не выводит автоматически. Передайте результат в [UI](../ui/), [ImGui](../imgui/), [NotificationController](../notification/) или другой API отображения.
