...
`Instigator` и `Victim` могут ссылаться на объекты игроков. Не сохраняйте такие ссылки надолго: агент может стать недоступен после выхода игрока или смены состояния матча.
