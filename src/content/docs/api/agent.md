...
Событие получения урона. Все поля структуры доступны для чтения и присваивания (`get/set`).
...
Событие смерти агента, передаваемое в коллбек `Agents:OnDeath()`. Все поля структуры доступны для чтения и присваивания (`get/set`).
...
Событие попадания. Все поля структуры доступны для чтения и присваивания (`get/set`).
