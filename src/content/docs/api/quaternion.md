...
`Quaternion.euler()` и getter `eulerAngles` используют несовместимые соглашения для комбинированного вращения. Проблема передана разработчику и будет исправлена в будущей сборке.
:::
