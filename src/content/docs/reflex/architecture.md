...
:::caution
Если нужное чтение или изменение недоступно в Reflex server API, клиентская реализация не становится равноценной серверной. Зафиксируйте ограничение и выберите другой дизайн.
:::
